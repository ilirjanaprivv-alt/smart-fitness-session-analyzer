...
class Observation:
    ...
    def is_valid(self):
        ...
        if (
            ...
            or not isinstance(self.heart_rate, (int, float))
            or self.heart_rate < 35
            or self.heart_rate > 205
        ):
            return False

        if (
            self.skin_response is None
            or not isinstance(self.skin_response, (int, float))
            or self.skin_response < 0
        ):
            return False
        ...
        if (
            ...
            or self.temperature < 25
            or self.temperature > 42
        ):
            return False

        if (
            self.activity_level is None
            or not isinstance(self.activity_level, (int, float))
            or self.activity_level < 0
            or self.activity_level > 1
        ):
            return False
